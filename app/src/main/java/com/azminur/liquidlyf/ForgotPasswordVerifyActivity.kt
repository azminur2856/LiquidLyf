...
class ForgotPasswordVerifyActivity : AppCompatActivity() {
    ...
    private fun startCountdown(seconds: Int) {
        ...
        object : CountDownTimer(seconds * 1000L, 1000) {
            ...
            override fun onFinish() {
                ...
                resendCodeLink.setTextColor(ContextCompat.getColor(this@ForgotPasswordVerifyActivity, R.color.red_button))
            }
        }.start()
    }
}